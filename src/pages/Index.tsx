  ...
  const features = [
    {
      ...
      description: t(
        "End-to-end encryption and blockchain technology ensure your vote remains secure and tamper-proof.",
        "एंड-टू-एंड एन्क्रिप्शन और ब्लॉकचेन तकनीक यह सुनिश्चित करती है कि आपका वोट सुरक्षित और छेड़छाड़-प्रूफ रहे।"
      )
    },
    {
      icon: BarChart,
      ...
      description: t(
        "Real-time vote counting with verifiable records that maintain electoral process integrity.",
        "सत्यापन योग्य रिकॉर्ड के साथ रीयल-टाइम वोट काउंटिंग जो चुनाव प्रक्रिया की अखंडता बनाए रखता है।"
      )
    },
    {
      icon: Users,
      ...
      description: t(
        "Designed with accessibility in mind, ensuring all citizens can participate in the democratic process.",
        "एक्सेसिबिलिटी को ध्यान में रखते हुए डिज़ाइन किया गया है, यह सुनिश्चित करता है कि सभी नागरिक लोकतांत्रिक प्रक्रिया में भाग ले सकें।"
      )
    },
    {
      icon: Lock,
      ...
      description: t(
        "Your vote is anonymous, with cryptographic protocols preserving verification while protecting your identity.",
        "आपका वोट गुमनाम है, क्रिप्टोग्राफिक प्रोटोकॉल आपकी पहचान की रक्षा करते हुए सत्यापन को बनाए रखते हैं।"
      )
    }
  ];
        ...
        <div className="max-w-screen-xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 animate-scale-in" style={{ animationDelay: "0.1s" }}>
              ...
              <p className="text-muted-foreground">
                {t(
                  "Select your candidate through our intuitive and accessible interface designed for all users.",
            ...
            <div className="text-center p-6 animate-scale-in" style={{ animationDelay: "0.2s" }}>
              ...
              <p className="text-muted-foreground">
                {t(
                  "Receive confirmation of your vote and track election results in real-time with complete transparency.",
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-screen-xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              {t(
                "Learn how to use our secure blockchain voting system with these helpful tutorials.",
                "इन सहायक ट्यूटोरियल के साथ हमारी सुरक्षित ब्लॉकचेन वोटिंग प्रणाली का उपयोग करना सीखें।"
              )}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="p-4 bg-secondary flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {t(
                      "A step-by-step guide to register as a voter and cast your vote securely.",
                      "एक मतदाता के रूप में पंजीकरण करने और सुरक्षित रूप से अपना वोट डालने के लिए चरण-दर-चरण मार्गदर्शिका।"
                    )}
                  </p>
                </div>
              </div>
            ...
            {/* Tutorial Video 2 */}
            <div className="rounded-xl overflow-hidden border border-border flex flex-col animate-fade-in" style={{ animationDelay: "0.1s" }}>
              <div className="aspect-video">
                <iframe
                  className="w-full h-full"
                  src="https://www.youtube.com/embed/dQw4w9WgXcQ"
              ...
              <div className="p-4 bg-secondary flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {t(
                      "Learn how blockchain technology ensures the security and integrity of your vote.",
                      "जानें कि ब्लॉकचेन तकनीक आपके वोट की सुरक्षा और अखंडता कैसे सुनिश्चित करती है।"
                    )}
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-screen-xl mx-auto text-center animate-fade-in">
          <h2 className="h2 mb-4">
            {t(
              ...
              "वोटिंग के भविष्य का अनुभव करने के लिए तैयार हैं?"
            )}
          </h2>
